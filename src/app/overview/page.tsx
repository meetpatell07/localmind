              ...
              >
                ...
                <div className="flex items-center justify-between mb-1.5">
                  ...
                  {event.sourceIcon && (
                    <div
                      className={cn(
                        "flex items-center justify-center p-1 rounded-md hidden md:flex",
                        event.sourceColor,
                      )}
                    >
                ...
                <div className="flex items-center gap-3 w-full">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="text-[13px] text-gray-500 flex items-center gap-1 truncate">
                      To:{" "}
                      <span className="text-gray-700">{event.recipient}</span>
                    </div>
                  </div>
                  {event.sourceIcon && (
                    <div
                      className={cn(
                        "flex md:hidden flex-shrink-0 items-center justify-center p-1 rounded-md",
                        event.sourceColor,
                      )}
                    >
                      <event.sourceIcon className="size-4" />
